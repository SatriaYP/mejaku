    ...
    <div class="content">
        ...
        <div class="reservation-card">
            ...
            <div class="action-buttons">
                <span class="status-badge">Sudah Datang</span>
                <button class="action-btn">Hubungi Costumer</button>
            </div>
        ...
        <div class="reservation-card">
            ...
            <div class="action-buttons">
                <button class="action-btn">Belum Datang</button>
                <button class="action-btn">Hubungi Costumer</button>
            </div>
            <div class="d-flex justify-content-end">
                <div class="table-number">Nomor Meja<br>2</div>
